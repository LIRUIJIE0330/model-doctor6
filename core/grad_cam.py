...
def main():
    ...
    model_name = 'vgg16'
    model_layers = [-1]
    model_path = os.path.join(config.output_model, 'gc', model_name + '_07311101', 'checkpoint.pth')
    images_path = os.path.join(config.output_result, model_name + '_07281512', 'images')
    result_path = os.path.join(config.output_result, model_name + '_07281512', 'cams')
